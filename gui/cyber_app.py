...
from record_page import RecordsPage
...
class CyberApp(ctk.CTk):
    def __init__(self):
        ...
        self.pages = {
            ...
            "stats": StatsPage(self.main_container),
            "records": RecordsPage(self.main_container)
        }
    ...
    def switch_page(self, page_name):
        if page_name in self.pages:
            ...
            print(f"Page '{page_name}' is not implemented yet!")
